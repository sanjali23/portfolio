...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    return(
       ...
       <p className='font-syne lg:text-5xl md:text-5xl text-2xl font-bold'>Drop an email to</p>
      ...
      {texts.map((text, index) => (
       ...
       <a href="mailto:sanjalisahu100@gmail.com" class="font-semibold uppercase mt-4 rounded-full button-gradient px-1 py-3 "><span className='px-8 py-3 inner-span rounded-full bg-black font-syne font-semibold'>sanjalisahu100@gmail.com
                    </span>
                  </a>
       </div>
       ...
       <a href="/"><span className=''>@SANJALI SAHU</span></a>
       <div className='flex gap-6'>
          <a href="https://www.linkedin.com/in/-sanjalisahu/"><span>Linkedin</span></a>
